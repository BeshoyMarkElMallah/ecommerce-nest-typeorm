...
export class OrdersController {
  ...
  @Put(':id')
  async update(@Param('id') id: string, @Body() updateOrderStateDto: UpdateOrderStatusDto, @CurrentUser() currentUser: UserEntity) {
    return await this.ordersService.update(+id, updateOrderStateDto, currentUser);
  }
